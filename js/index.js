...
/*#################################################
#9 	(DONE) My list count wont UPDATE when I add a new item! 
It works when I delete an item! -BC 

- Hobie: now it counts if you add or delete items
#################################################*/
...
/*#################################################
#10* (DONE) 	Okay, this one is not just a fix of something I 
...
-Hobie= it adds a fav sign to every (new) item in the list
...
-BC 
-     step 1= tell the users the rules of adding new items 
              - no duplicate
			  - no empty list items
	  step 2= GO AHEAD AND CODE IT!!! 
#################################################*/		
